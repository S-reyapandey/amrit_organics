...
function PsylliumHuskPowder() {
  const feature = [
    {
      ...
      description: "Sourced from premium-quality Plantago ovata seeds to ensure maximum purity and effectiveness.",
    },
    {
      id: 2,
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50">
            ...
            >
              ...
              <Typography sx={{ color: "#fff" }}>Psyllium Husk Powder</Typography>
            </Breadcrumbs>
          </div>
        </div>
      </div>
       ...
       <div className="flex flex-col md:flex-row items-center gap-12">
         ...
         <div className="prose prose-gray max-w-none">
           <p className="font-['Manrope'] text-base leading-relaxed text-gray-700">
             <b><i>Psyllium Husk Powder: A High-Quality Natural Fibre </i></b>is a finely ground form of the husk derived from the seeds of the Plantago ovata plant. Rich in dietary fiber, it is a natural and versatile ingredient known for its ability to support digestive health, heart wellness, and weight management. 
           </p>
           
           <p className="font-['Manrope'] text-base leading-relaxed text-gray-700 mt-4">
           Widely used in the food, nutraceutical, pharmaceutical, and wellness industries, psyllium husk powder is valued for its health benefits and adaptability in various applications.
           </p>
           
           <p className="font-['Manrope'] text-base leading-relaxed text-gray-700 mt-4">
           At Amrit Organics, we offer premium-quality psyllium husk powder, meticulously processed to retain its natural properties while adhering to the highest global standards of purity and quality.
           </p>
         </div>
   ...
   <div className="container mx-auto px-16 mb-12">
    ...
    >
      ...
      <div className="w-full sm:w-2/3">
        ...
        >Psyllium husk powder is a natural, plant-based fiber with unmatched benefits:
          <li><b>Digestive Support :</b> Promotes healthy digestion and regular bowel movements.</li>
          <li><b>Heart Health :</b> Helps lower cholesterol levels and supports cardiovascular wellness.</li>
          <li><b>Weight Management :</b>
          Encourages a feeling of fullness, aiding in appetite control.
          </li>
          <li><b>Blood Sugar Regulation :</b>Slows carbohydrate digestion, stabilizing blood sugar levels.</li>
        </p>
      </div>
    </div>
  </div>
 ...
 <p
   ...
   style={{ lineHeight: "1.6", fontSize: "0.9rem" }}
 >
   <li><b>Experienced Exporter :</b> Trusted supplier to North America, Europe, Asia, and the Middle East.</li>
   <li><b>Unmatched Quality :</b> Through quality checks to ensure purity, consistency, and safety</li>
   <li><b>Sustainable Practices :</b> Eco-friendly sourcing and processing methods.
   </li>
   <li><b>Reliable Logistics </b></li>
 </p>
</div>
    ...
    <p>
    At Amrit Organics, we are committed to meeting your needs with premium products and exceptional service.<br/>
Reach out to us today for samples, quotes, or to discuss your specific requirements.
