    ...
    <div className="px-4 mb-20">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50">
              ...
              >
                ...
                <Typography sx={{ color: "#fff" }}>Psyllium Seed</Typography>
              </Breadcrumbs>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="prose prose-gray max-w-none">
              <p className="font-['Manrope'] text-base leading-relaxed text-gray-700">
                Psyllium seeds are small, brown seeds derived from the Plantago
                ovata plant. They contain high levels of soluble fiber (10-30%)
                and swell significantly when mixed with water to form a gel-like
      ...
      {/*Name section */}
        ...
        <div className="container mx-auto px-10 mb-12">
          <h2 style={{fontFamily: "Signika", fontSize: "1.3rem"}} className="mb-3"><b><i>Botanical Names of Psyllium Seeds :</i></b></h2>
        ...
        <div className="w-full mb-8 px-6">
          {/* Card Container */}
          <div className="max-w-full flex flex-col sm:flex-row items-center p-5 border border-gray-400 rounded-lg shadow-md hover:shadow-2xl transition-all duration-300 ease-in-out" style={{backgroundColor: "#DBD2"}}>
        ...
        <h2 style={{fontFamily: "Signika", fontSize: "1.1rem", fontWeight: "600"}} className="mb-3">Looking for a trusted supplier of high-quality psyllium seeds?</h2>
        <p>At Amrit Organics, we are dedicated to meeting your needs with excellence.
        Get in touch today to request a quote, product samples, or learn more about our offerings.
        </p>
